<script>
    ...
    const navigateToHome = () => goto('/marketing/agent-dashboard',{ replaceState : true })
...
<main class="py-20">
    ...
    {#if successMsg}
        <AlertModal message={successMsg} msgTextColor={'green'} handleOnOk={navigateToHome}/>
    {/if}
    ...
    <Card class="max-w-lg mx-auto">
        ...
        <form onsubmit={handlepasswordChange} class="space-y-2">
